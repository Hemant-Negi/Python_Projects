from tkinter import *
#making window named root
root = Tk()
root.geometry('400x350')
root.config(bg='azure')
root.title('Madlib Project')
Label(root, text= 'Mad Libs Generator \n Have Fun!' , font = 'arial 20 bold',foreground='green').pack()
Label(root, text = 'TRY AnyOne :', font = 'arial 15 bold',foreground='blue').place(x=60, y=90)
#madlib function
def madlib1():
...
Button(root, text= 'The Photographer', font ='arial 15', command= madlib1, bg = 'ghost white').place(x=60, y=140)
Button(root, text= 'apple and apple', font ='arial 15', command = madlib3 , bg = 'ghost white').place(x=60, y=190)
